...
document.getElementById('ver').addEventListener('click', function () {
    // Redirige a otra página
    window.location.href = '../Coordinador/8-crearBoletin.html';
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    eliminarBotones.forEach(boton => {
        boton.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                text: "Puedes eliminar o modificar este Boletin.",
                icon: 'warning',
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            ...
                            if (!nuevoHorario || !nuevaJornada) {
                                ...
                                Swal.fire('¡Modificado!', 'El Boletin ha sido actualizado.', 'success');
    ...
    crearHorarioButton.addEventListener('click', function() {
        Swal.fire({
            ...
            `,
            confirmButtonText: 'Crear Boletin',
            showCancelButton: true,
            cancelButtonText: 'Cancelar',
            preConfirm: () => {
                ...
                if (!nuevoHorario || !nuevaJornada) {
                    ...
                    nuevoElemento.innerHTML = `
                        ...
                        <button class="ver-horario">Ver Boletin</button>
