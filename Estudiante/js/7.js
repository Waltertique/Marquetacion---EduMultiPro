...
document.getElementById('trabajos').addEventListener('click', function () {
    // Redirige a otra página
    window.location.href = '../Estudiante/7-listaTrabajo.html';
});

document.getElementById('personas').addEventListener('click', function () {
    // Redirige a otra página
    window.location.href = '../Estudiante/8-personas.html';
});

// Ver Tareas

document.getElementById('verTarea').addEventListener('click', function () {
    // Redirige a otra página
    window.location.href = '../Estudiante/9-subirTrabajo.html';
});

document.getElementById('verTarea1').addEventListener('click', function () {
    // Redirige a otra página
    window.location.href = '../Estudiante/9-subirTrabajo.html';
});

document.getElementById('verTarea2').addEventListener('click', function () {
    // Redirige a otra página
    window.location.href = '../Estudiante/9-subirTrabajo.html';
});

document.getElementById('verTarea3').addEventListener('click', function () {
    // Redirige a otra página
    window.location.href = '../Estudiante/9-subirTrabajo.html';
});
