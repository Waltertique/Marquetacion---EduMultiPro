...
document.getElementById('apartado2').addEventListener('click', function () {
    // Redirige a otra página
    window.location.href = '../Profesor/14-listaCalificaciones.html';
});

document.getElementById('apartado3').addEventListener('click', function () {
    // Redirige a otra página
    window.location.href = '../Profesor/14-listaCalificaciones.html';
});

document.getElementById('apartado4').addEventListener('click', function () {
    // Redirige a otra página
    window.location.href = '../Profesor/14-listaCalificaciones.html';
});
